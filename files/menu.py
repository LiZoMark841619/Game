...
class GameMenu(Menu):
    def ask_to_play(self) -> bool:
        return (self.get_valid_string('Would you like to play? Enter yes/no? ', 'yes', 'no') == 'yes')
    ...
    def want_to_quit(self) -> bool:
        return (self.get_valid_string('Would you like to quit? Enter yes/no? ', 'yes', 'no') == 'yes')